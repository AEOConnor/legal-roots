        ...
        <div className="consultationInfo">
          ...
          <div>
            <form action="/action_page.php" onSubmit={props.handleFormSubmit}>
              <label className="visuallyHidden">First Name</label>
              <input type="text" id="fName" name="firstname" value={props.fName} onChange={props.handleChange} placeholder="Your first name.." />
              <label className="visuallyHidden">Last Name</label>
              ...
              <label className="visuallyHidden">Subject</label>
